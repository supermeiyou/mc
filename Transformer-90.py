...
if __name__ == "__main__":
    ...
    for exp in range(N_EXPERIMENTS):
        ...
        plt.title(f"Transformer 预测未来90天 Global Active Power - 实验{exp+1}")
        plt.legend()
        plt.grid(True)
        plt.tight_layout()
        plt.savefig(f"image/Transformer-90-{exp+1}.png")
        plt.close()
    ...
    # plt.legend()
    # plt.tight_layout()
    # plt.savefig('image/Transformer-90-bar.png')
    # plt.close()

    # print("Finished! -> image/Transformer-90-bar.png") 